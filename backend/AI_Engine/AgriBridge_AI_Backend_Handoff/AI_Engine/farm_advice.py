...
def generate_farm_specific_advice(
    ...
    # ============================================================
    # FERTILIZER RECOMMENDATION (Structured)
    # ============================================================
    
    try:
        from app.services.fertilizer_recommendation_engine import evaluate_fertilizer_recommendation
    except ImportError:
        try:
            from backend.app.services.fertilizer_recommendation_engine import evaluate_fertilizer_recommendation
        except ImportError:
            def evaluate_fertilizer_recommendation(*args, **kwargs):
                return {}

    fertilizer_recommendation = evaluate_fertilizer_recommendation(
